...
if  os.path.isfile(args.bamIn):
	...
	with open(job_file,"w") as fh:
		...
		fh.writelines("#SBATCH --time=80:00:00\n")
		fh.writelines("#SBATCH --mem=45G\n")
		fh.writelines("#SBATCH --cpus-per-task=12\n")
		...
		fh.writelines("\n")
		fh.writelines("source activate RNA-Seq_Alignment\n")
		fh.writelines("trust -f " + workDir + "/bam_aligned/" + outName + ".bam -n 10 -g hg38 -E -o " + workDir + "/trust/ \n")
		fh.writelines("echo 'TRUST TCR analysis step complete'\n")
		fh.writelines("trust -f " + workDir + "/bam_aligned/" + outName + ".bam -n 10 -g hg38 -B -o " + workDir + "/trust/ \n")
		fh.writelines("echo 'TRUST BCR heavy chain analysis step complete'\n")	
		fh.writelines("trust -f " + workDir + "/bam_aligned/" + outName + ".bam -n 10 -g hg38 -B -L -o " + workDir + "/trust/ \n")
		fh.writelines("echo 'TRUST BCR light chain analysis step complete'\n")	
		fh.writelines("\n")
		fh.writelines("htseq-count -m intersection-nonempty -i gene_id -r pos -s no -f bam " + workDir + "/bam_aligned/" + outName + ".bam " + workDir + "/resources/annotation/gencode.v22.annotation.gtf > " + workDir + "/htseq/" + outName + ".txt \n")
		fh.writelines("echo 'htseq-count step complete'\n")	
		fh.writelines("source deactivate\n")
		fh.writelines("\n")
	...
	with open(job_file,"w") as fh:
		...
		fh.writelines("\n")
		fh.writelines("source activate RNA-Seq_Alignment\n")
		fh.writelines("trust -f " + workDir + "/" + outName + "/bam/${bamNameList[$SLURM_ARRAY_TASK_ID]}.bam -n 10 -g hg38 -E -o " + workDir + "/" + outName + "/trust/ \n")
		fh.writelines("echo 'TRUST TCR analysis step complete'\n")		
		fh.writelines("trust -f " + workDir + "/" + outName + "/bam/${bamNameList[$SLURM_ARRAY_TASK_ID]}.bam -n 10 -g hg38 -B -o " + workDir + "/" + outName + "/trust/ \n")
		fh.writelines("echo 'TRUST BCR heavy chain analysis step complete'\n")	
		fh.writelines("trust -f " + workDir + "/" + outName + "/bam/${bamNameList[$SLURM_ARRAY_TASK_ID]}.bam -n 10 -g hg38 -B -L -o " + workDir + "/" + outName + "/trust/ \n")
		fh.writelines("echo 'TRUST BCR light chain analysis step complete'\n")	
		fh.writelines("\n")
