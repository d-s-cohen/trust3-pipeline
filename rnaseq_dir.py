...
with open(job_file,"w") as fh:
        ...
        fh.writelines("\n")
        fh.writelines("mv  -t " + workDir + "/bam_aligned/ " + workDir + "/${bamNameList[$SLURM_ARRAY_TASK_ID]}/${bamNameList[$SLURM_ARRAY_TASK_ID]}.bam " +  workDir + "/${bamNameList[$SLURM_ARRAY_TASK_ID]}/${bamNameList[$SLURM_ARRAY_TASK_ID]}.bam.bai \n" )
        fh.writelines("mv  -t " + workDir + "/fastq/ " + workDir + "/${bamNameList[$SLURM_ARRAY_TASK_ID]}/fastq/${bamNameList[$SLURM_ARRAY_TASK_ID]}_1.fastq.gz " + workDir + "/${bamNameList[$SLURM_ARRAY_TASK_ID]}/fastq/${bamNameList[$SLURM_ARRAY_TASK_ID]}_2.fastq.gz \n")
        fh.writelines("mv " + workDir + "/${bamNameList[$SLURM_ARRAY_TASK_ID]}/Log.final.out " + workDir + "/log/${bamNameList[$SLURM_ARRAY_TASK_ID]}.out \n")
        fh.writelines("mv " + workDir + "/${bamNameList[$SLURM_ARRAY_TASK_ID]}/Log_1st_pass.final.out " + workDir + "/log/${bamNameList[$SLURM_ARRAY_TASK_ID]}_1st_pass.out \n")
